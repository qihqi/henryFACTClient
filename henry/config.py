...
from henry.constants import (INGRESO_PATH, BEAKER_DIR, IMAGE_PATH, TEMPLATE_LOCATION, REVISION_PATH)
...
revisionapi = DocumentApi(sessionmanager, FileService(REVISION_PATH), transactionapi, object_cls=Revision)
